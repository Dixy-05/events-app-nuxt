		...
		div
			section
				form
					...
					b-field(label="Last Name" :label-position="lastName!=''?'on-border':'inside'" :type="submit==false?(firstName !=''? 'is-success':''):(firstName !=''?'is-success':'is-danger')")
						b-input(placeholder="Last Name" v-model="lastName" )
					b-field(label="Email" :label-position="email!=''?'on-border':'inside'" :type="submit==false?(firstName !=''? 'is-success':''):(firstName !=''?'is-success':'is-danger')")
