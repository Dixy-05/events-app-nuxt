<template lang="pug">
	div.container
		...
		div
			section
				form
					validateProvider(rules="required" v-slot="{errors,valid}")
						b-field(label="First Name" :label-position="form.firstName!=''?'on-border':'inside'" :type="{'is-danger':errors[0],'is-success':valid}"  :message="submit&&form.firstName==''?'Most complete this field':''")
