				...
				section
					form
						...
						ValidationProvider(rules="required" name="Last Name" v-slot="{errors,valid}")
							b-field(label="Last Name" :label-position="form.lastName!=''?'on-border':'inside'" :type="{'is-danger':errors[0],'is-success':valid}" :message="submit&&form.lastName==''?'Most complete this field':''")
